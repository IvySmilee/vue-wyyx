<template>
  <div class="m_better_goods">
    <header class="items_head">
      <a class="head_content" href="">
        <span class="title">人气推荐<sup>.</sup>好物精选</span>
        <div class="more">
          <span>查看全部</span>
          <i></i>
        </div>
    ...
    <div class="better_items">
      <ul class="itemList">
        <li class="item" v-for="(obj,index) in betterGoodsList" :key="index">
          <a class="item_info">
            <div class="img">
...
<script>
  ...
  export default {
    mounted(){
      this.$store.dispatch('getBetterGoods');
